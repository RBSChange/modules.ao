<?php
class ao_FoldercompanyService extends generic_FolderService
{
	/**
	 * @var ao_FoldercompanyService
	 */
	...
	{
		return $this->getNewDocumentInstanceByModelName('modules_ao/foldercompany');
	}

	/**
	 * Create a query based on 'modules_ao/foldercompany' model
	 * @return f_persistentdocument_criteria_Query
	 */
	public function createQuery()
	{
		return $this->pp->createQuery('modules_ao/foldercompany');
	}

	/**
	 * @param ao_persistentdocument_foldercompany $document
...
//	}
	...
	/**
	 * @param ao_persistentdocument_foldercompany $fromDocument
...
//	}
	 ...
	 * @param ao_persistentdocument_foldercompany $toDocument
	 * @param String $tag
	 * @return void
	 */
