<?php
class ao_FolderthemeService extends generic_FolderService
{
	/**
	 * @var ao_FolderthemeService
	 */
	...
	{
		return $this->getNewDocumentInstanceByModelName('modules_ao/foldertheme');
	}

	/**
	 * Create a query based on 'modules_ao/foldertheme' model
	 * @return f_persistentdocument_criteria_Query
	 */
	public function createQuery()
	{
		return $this->pp->createQuery('modules_ao/foldertheme');
	}

	/**
	 * @param ao_persistentdocument_foldertheme $document
...
//	}
	...
	/**
	 * @param ao_persistentdocument_foldertheme $fromDocument
...
//	}
	 ...
	 * @param ao_persistentdocument_foldertheme $toDocument
	 * @param String $tag
	 * @return void
	 */
